...
void odbudujListe(FILE *plik, Lista *Nowa) {
	
	fseek(plik, 0L, SEEK_END);								
	int iloscStruktur = ftell(plik)/sizeof(Element);	
	//printf("%d", iloscStruktur);
	Element* n;												
