...
struct pojazd danePodstawowe (struct pojazd egzemplarz) {
...
struct pojazd daneSzczegolowe (struct pojazd egzemplarz) {
...
int main (void) {
	...
	for(index = 0; index < iloscPojazdow; index++) {
		...
		tablica[index] = danePodstawowe(tablica[index]);
		tablica[index] = daneSzczegolowe(tablica[index]);
